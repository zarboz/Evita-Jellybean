...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 1, {  1728000, HFPLL, 1, 0, 0x40 }, L2(19), 1350000 },
...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_fast[] = {
	...
	{ 1, {  1836000, HFPLL, 1, 0, 0x44 }, L2(20), 1300000 },
	{ 0, { 0 } }
};

static struct acpu_level acpu_freq_tbl_8960_kraitv2_faster[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   800000 },
	{ 1, {   192000, PLL_8, 0, 2, 0x00 }, L2(0),   825000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   850000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   875000 },
	...
	{ 1, {  1836000, HFPLL, 1, 0, 0x44 }, L2(20), 1250000 },
	{ 0, { 0 } }
};
...
static struct acpu_level *acpu_freq_tbl_8960_v2[NUM_PVS] __initdata = {
	...
	[PVS_FASTER]  = acpu_freq_tbl_8960_kraitv2_faster,
};
...
uint32_t acpu_check_khz_value(unsigned long khz)
{
	...
	for (f = acpu_freq_tbl_8960_kraitv2_slow, acpu_freq_tbl_8960_kraitv2_nom, acpu_freq_tbl_8960_kraitv2_fast, acpu_freq_tbl_8960_kraitv2_faster; f->speed.khz != 0; f++) {
		if (khz < 192000) {
...
unsigned long acpuclk_8960_power_collapse(void)
{
	...
	acpuclk_8960_set_rate(smp_processor_id(), 304000, SETRATE_PC);
	return rate;
}
