...
static struct acpu_level acpu_freq_tbl_8960_kraitv2_slow[] = {
	...
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(17), 1250000 },
        ...
        { 1, {  1809000, HFPLL, 1, 0, 0x40 }, L2(19), 1300000 },
	{ 0, { 0 } }
};
...
>>>>>>> ca90ed5... removing faux's name from kmsg leaving it everywhere else just dont want to see his name on my kmsg really
